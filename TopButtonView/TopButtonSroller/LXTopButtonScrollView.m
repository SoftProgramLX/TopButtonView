...
- (id)initWithFrame:(CGRect)frame andTitleArray:(NSArray*)titleArray andDelegate:(id<LXTopViewSelectDelegate>)delegate
{
    ...
    if (self) {
        ...
        self.backgroundColor = LXColor(230, 230, 230);
...
- (void)initWithNameButtons
{
    ...
    [_shadowImageView setImage:[UIImage imageNamed:@"icon_bg_tab.png"]];
    ...
    for (int i = 0; i < [self.titleArray count]; i++) {
        ...
        [button setTitleColor: LXColor(255, 0, 0) forState:UIControlStateSelected];
